...
declare namespace Cloudflare {
	...
	interface Env {
		...
		Sandbox: DurableObjectNamespace<import("./src/providers/cloudflare/agent-worker/src/index").Sandbox>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INTERNAL_API_KEY" | "SANDBOX_LOG_LEVEL" | "SANDBOX_LOG_FORMAT">> {}
}
